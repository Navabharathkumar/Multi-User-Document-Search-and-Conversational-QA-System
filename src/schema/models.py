...
class HFModelName(StrEnum):
    MPNET_EMBED = "sentence-transformers/all-mpnet-base-v2"
    MINILM_EMBED = "sentence-transformers/all-MiniLM-L6-v2"
    HF_MIXTRAL = "mistralai/Mixtral-8x7B-Instruct-v0.1"
