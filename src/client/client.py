...
class AgentClient:
    ...
    async def ainvoke(
        self, message: str, model: str | None = None, thread_id: str | None = None, custom_data: list[dict] | None = None
    ) -> ChatMessage:
        """
        ...
        Args:
            ...
            custom_data (list[dict], optional): Additional user data to pass to the agent
